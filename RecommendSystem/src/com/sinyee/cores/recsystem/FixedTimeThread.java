...
/**
 * @ClassName: FixedTimeThread
 * @Description: 固定时间线程
 * @author: hiwes
 * @date: 2018年4月16日
 */
public class FixedTimeThread extends Thread {
	...
	public void run() {
		...
		// // 获取用户列表,需要的话就是在更新用户推荐结果的时候需要
		// List<Integer> UsersList = originalRatings.map(x ->
		// x.user()).distinct().collect();
		// 设定最佳参数，并进行建模
